![.NET 8](https://img.shields.io/badge/.NET-8-brightgreen)
# Утиліта для визначення та показу системної інформації
На екрані відображається наступна інформація:
* ліцензійний ключ Windows
* MAC-адреса
* ім'я ПК

Далі ця інформація зберігається в текстовий файл, з іменем наступного формату: ім'я_ПК_поточна_дата.txt
